export function Rules() {
  return (
    <div className="container my-12 mx-auto p-8 md:p-12 w-11/12 md:w-4/5 bg-[#121212]/80 backdrop-blur-sm rounded-xl text-white border border-[#585858]/30">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">2. Language</h2>
        <ul className="pl-6 space-y-2 list-disc border-none">
          <li className="text-gray-300 font-normal border-none">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">3. Speech Rounds</h2>
        <ul className="pl-6 space-y-2 list-disc border-none">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">5. Speech Timings</h2>
        <ul className="pl-6 space-y-2 list-disc border-none">
          <li className="text-gray-300 font-normal border-none">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">6. Speech Topics and Content</h2>
        <ul className="pl-6 space-y-2 list-disc border-none">
          <li className="text-gray-300 font-normal border-none">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">7. Use of Props and Electronic Devices</h2>
        <ul className="pl-6 space-y-2 list-disc border-none">
          <li className="text-gray-300 font-normal pt-1 pb-2 border-none">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">8. Protests and Disqualifications</h2>
        <ul className="pl-6 space-y-2 list-disc border-none">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">9. Dress Code</h2>
        <ul className="pl-6 space-y-2 list-disc border-none">
          <li className="text-gray-300 font-normal pt-1 pb-2 border-none">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">10. Speech Evaluation Criteria</h2>
        <ul className="pl-6 space-y-2 list-disc border-none">
          <li className="text-gray-300 font-normal pt-1 pb-2 border-none">
