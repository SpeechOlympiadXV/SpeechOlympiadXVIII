...
export function Vote() {
  ...
  return (
    <div className="px-8 py-10 w-[90%] sm:w-[80%] md:w-[60%] h-auto mx-auto my-10 bg-gradient-to-br rounded-xl from-[#282828] to-[#EDC00111] mt-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
        <a
          ...
          className="w-full h-12 flex items-center justify-center hover:shadow-md hover:shadow-[#edc00155] hover:text-gray-100 bg-gray-700 bg-gradient-to-br transition-all duration-500 from-[#EDC001aa] via-[#EDC001] to-[#EDC001aa] rounded-lg"
        >
