...
export function Doodle({}: DoodleProps) {
  ...
  // Update path stroke colors when color scheme changes
  useEffect(() => {
    ...
    paths.forEach((path) => {
      path.style.stroke = colorScheme === 'dark' ? 'gold' : 'black'
    })
  }, [colorScheme])
      ...
      >
        <g id="Layer_1-2" data-name="Layer 1">
          <path
            ...
            transform="translate(-154.87 -165.32)"
            fill="none"
            strokeMiterlimit="10"
            strokeWidth="2"
          />
          ...
          />
          <path
            d="M248.17,668.34c49.57,31.31,97.49-14.45,97.49-14.45s13.28,43.91,107.23,48"
            transform="translate(-154.87 -165.32)"
            fill="none"
            strokeMiterlimit="10"
            strokeWidth="2"
          ...
          />
          <path
            d="M383.19,332s-51.06,3.24-65.62,41.53c0,0-34.8,63.84,29.19,93.84"
            transform="translate(-154.87 -165.32)"
            fill="none"
            strokeMiterlimit="10"
            strokeWidth="2"
