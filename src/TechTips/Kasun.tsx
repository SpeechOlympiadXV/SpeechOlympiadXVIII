...
export function Kasun() {
  return (
    ...
    >
      <h1 className="text-3xl font-bold text-[#EDC001] mb-6 mt-4 text-center">
      ...
      <ol className="list-decimal pl-6 space-y-1 mt-2 mb-8 font-semibold text-[#EDC001]">
        <li>Physical</li>
        <li>Voice</li>
        <li>Manner</li>
      </ol>

      <h2 className="text-2xl font-bold text-[#EDC001] border-b border-gray-600 pb-2 mb-4">1. Physical</h2>
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-2">What you wear</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-white mt-8 mb-2">How your body moves</h3>
      <p>
      ...
      <h3 className="text-xl font-bold text-white mt-8 mb-2">Where your body moves on stage</h3>
      ...
      <h4 className="text-lg font-bold text-gray-300 mt-4 mb-1">Where to start</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-bold text-gray-300 mt-4 mb-1">Timeline Technique</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-bold text-gray-300 mt-4 mb-1">Location Technique</h4>
      <p className="mb-4">
      ...
      <h4 className="text-lg font-bold text-gray-300 mt-4 mb-1">Dialogue</h4>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-bold text-[#EDC001] border-b border-gray-600 pb-2 mt-10 mb-4">2. Voice</h2>
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-2">Pitch</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-2">Pace</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-2">Pause</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-2">Power</h3>
      <p className="mb-8">
      ...
      <h2 className="text-2xl font-bold text-[#EDC001] border-b border-gray-600 pb-2 mt-10 mb-4">3. Manner</h2>
      <p>
      ...
      <h3 className="text-xl font-bold text-white mt-8 mb-2">Asking questions</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-2">Take examples from the audience</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-2">React to the audience</h3>
      <p className="mb-4">
      ...
      <h3 className="text-xl font-bold text-white mt-6 mb-2">Maintain eye contact</h3>
      <p className="mb-6">
      ...
      <p className="text-lg italic font-medium text-gray-300 border-l-4 border-[#EDC001] pl-4 py-2 bg-white/5 mt-8 mb-6">
      ...
      <p className="text-xl font-bold text-[#EDC001] text-center mb-8">
