...
export function Madushika() {
  return (
    ...
    >
      <h2 className="heading-page text-ember mt-4 mb-4">
      ...
      <h2 className="heading-sub text-ember mt-8 mb-4">The Art of Storytelling</h2>
      <p>
      ...
      <h2 className="heading-sub text-ember mt-8 mb-4">Structuring Your Speech</h2>
      <p>
      ...
      <h2 className="heading-sub text-ember mt-8 mb-4">Delivering Your Speech</h2>
      <p>
      ...
      <p className="mb-6 font-semibold italic text-ember/80">
      ...
      <h2 className="heading-sub text-ember mt-8 mb-4">Where to Find Stories</h2>
      <p>
      ...
      <h2 className="heading-sub text-ember mt-8 mb-4">How to Craft the Speech</h2>
      <ul className="list-disc pl-6 space-y-2 mt-4 mb-4">
        <li>
      ...
      <h2 className="heading-sub text-ember mt-8 mb-4">Evaluation Criteria of Gavel</h2>
      <p>
      ...
      <h2 className="heading-sub text-ember mt-8 mb-4">In Conclusion</h2>
      <p>
